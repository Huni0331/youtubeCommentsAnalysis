...
df = pd.read_table('getCommentFromYoutube/data/ratings_train.txt') # 파일 명
...
with open('getCommentFromYoutube/data/df_token.csv', 'rb') as lf:
...
from getCommentFromYoutube.views import send_reviews
...
global loaded_model
loaded_model = load_model('getCommentFromYoutube/data/best_model.h5')
